...
- (void)viewDidLoad {
    ...
    }else if (self.mode == PhotoMaskViewModeSquare) {
...
//    icn_back.png
    ...
    titleLabel.text = _cropTitle?_cropTitle: (self.mode == PhotoMaskViewModeNone ? @"预览" : @"移动和缩放");
...
- (UIImage *)cropImage {
    if (self.mode == PhotoMaskViewModeNone) {
